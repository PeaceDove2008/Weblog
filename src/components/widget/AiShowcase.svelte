...
<div class="card-base tinted !overflow-visible p-3" style="--card-tint: oklch(0.93 0.08 55)">
	...
	<div class="relative overflow-hidden mt-3 rounded-lg border-[2px] border-[var(--brutal-border)] bg-[var(--card-bg)] shadow-[1px_1px_0_0_var(--brutal-shadow)] py-1.5">
		<div class="marquee-track font-bold text-[var(--sticker-orange)] dark:text-[oklch(0.80_0.13_55)] whitespace-nowrap">
			{marqueeText}
		</div>
	</div>
</div>
