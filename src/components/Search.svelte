...
<div id="search-bar" class="hidden lg:flex transition-all items-center h-11 mr-2 rounded-lg
      bg-[var(--card-bg)] hover:bg-[var(--btn-card-bg-hover)]
      border-[2px] border-[var(--brutal-border)] shadow-[2px_2px_0_0_var(--brutal-shadow)]
      focus-within:translate-x-[1px] focus-within:translate-y-[1px] focus-within:shadow-none
      dark:shadow-[2px_2px_0_0_var(--brutal-shadow)]
">
